#!/usr/bin/env python3
"""Minimal stateless Streamable HTTP transport for the Manifold connector."""
...
class Handler(BaseHTTPRequestHandler):
    server_version = "BratonienManifoldMCP/0.1"
...
def main() -> None:
    ...
    print(f"Manifold MCP connector listening on http://{host}:{port}/mcp", flush=True)
    httpd.serve_forever()
